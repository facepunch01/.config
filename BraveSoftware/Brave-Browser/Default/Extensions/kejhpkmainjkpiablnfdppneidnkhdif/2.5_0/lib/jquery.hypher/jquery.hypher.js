...
Hypher.prototype.createTrie = function (patternObject) {
	...
	// Build the language trie from the pattern object
...
// Extension method added 09/04/2014
// Anthony Nosek
// Pass in a word and a hyphenated word array is returned 
$.fn.hyphenateWord = function(word, language, minLength) {
	if (window['Hypher']['languages'][language]) {
		var delimiter = '-**DELI()MITER**-';
    	var hyphenatedWord = window['Hypher']['languages'][language].hyphenateText(word, minLength);
		var result = hyphenatedWord.replace(/[\u00AD\u002D\u2011]+/g, delimiter);
